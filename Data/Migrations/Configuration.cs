        ...
        protected override void Seed(Entities context)
        {
            ...
            if (!context.Roles.Any(x => x.Name == "wifi-moderator"))
                context.Roles.Add(
                    ...
                    {
                        Name = "wifi-moderator",
                        FriendlyName = "Tauschbörsenmoderator"
                    }
                );
            ...
            if (!context.UserNoteActions.Any(x => x.CodeHandle == "tb-offer-deleted"))
                context.UserNoteActions.Add(
                    new UserNoteAction()
                    {
                        Name = "Tauschbörse: Angebot gel?scht",
            ...
            if (!context.UserNoteActions.Any(x => x.CodeHandle == "tb-offer-reopened"))
                context.UserNoteActions.Add(
                    new UserNoteAction()
                    {
                        Name = "Tauschbörse: Angebot erneut freigegeben",
            ...
            if (!context.UserNoteActions.Any(x => x.CodeHandle == "tb-offer-cheat-add"))
                context.UserNoteActions.Add(
                    new UserNoteAction()
                    {
                        Name = "Tauschbörse: Angebot als Cheat markiert",
            ...
            if (!context.UserNoteActions.Any(x => x.CodeHandle == "tb-offer-cheat-remove"))
                context.UserNoteActions.Add(
                    new UserNoteAction()
                    {
                        Name = "Tauschbörse: Angebot als Legit markiert",
            ...
            if (!context.UserNoteActions.Any(x => x.Name == "Vorschlag zum Rangtr鋑er"))
                context.UserNoteActions.Add(
                    new UserNoteAction()
                    {
                        Name = "Vorschlag zum Rangtr鋑er",
                        IsUserSelectable = true
                    });
