...
namespace Pokefans.Data
{
    ...
    public partial class User : IUser<int>
    {
        ...
        // this has nothing to do with bans but everything to do with managing
        // failed log in attempts. After a certain number of failed attempts
        // the user has to wait 15 minutes before attempting again; however
        ...
        [MaxLength(34)]
        public virtual string phpBBPassword { get; set; }
