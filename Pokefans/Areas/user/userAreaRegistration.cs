    ...
    public class userAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.Routes.Add(new DomainRoute(
                    ...
                    new { action = "ChangePassword", controller = "Manage", id = UrlParameter.Optional }));

			context.Routes.Add(new DomainRoute(
					"user." + ConfigurationManager.AppSettings["Domain"],
					"einstellungen/passwort-setzen",
					new { action = "SetPassword", controller = "Manage", id = UrlParameter.Optional }));

			context.Routes.Add(new DomainRoute(
					"user." + ConfigurationManager.AppSettings["Domain"],
					"einstellungen/link-account",
					new { action = "LinkLogin", controller = "Manage", id = UrlParameter.Optional }));

			context.Routes.Add(new DomainRoute(
					"user." + ConfigurationManager.AppSettings["Domain"],
					"einstellungen/unlink-account",
					new { action = "RemoveLogin", controller = "Manage", id = UrlParameter.Optional }));

			context.Routes.Add(new DomainRoute(
					"user." + ConfigurationManager.AppSettings["Domain"],
					"einstellungen/accounts-verwalten",
					new { action = "ManageLogins", controller = "Manage", id = UrlParameter.Optional }));
